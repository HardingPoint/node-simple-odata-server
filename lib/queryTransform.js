...
Node.prototype.transform = function () {
  ...
  console.log('this.type : ' + this.type + ' this.right.type: ' + this.right.type);
  console.log('this.left.name: ' + this.left.name + ' this.right.value: ' + this.right.value);
