...
module.exports = function (cfg, req, res) {
  ...
  console.log('[GRAX.io] Raw Url : ' + req.url );
  ...
  if (_url.search) {
    ...
    console.log('[GRAX.io] Raw query : ' + JSON.stringify(encodedQS));
    if (encodedQS) {
    ...
    if (query.$count) {
      ...
      console.log('[GRAX.io] Skipped Parsing' );
      console.log('[GRAX.io] _url.search : ' + _url.search );
  }
