...
function getdefinition(){
    var result = '<?xml version="1.0" encoding="UTF-8"?>' +
        '<service xmlns="http://www.w3.org/2007/app" xmlns:atom="http://www.w3.org/2005/Atom" xmlns:m="http://docs.oasis-open.org/odata/ns/metadata" xml:base="' + GRAXUrl + BaseRoute + '/" m:context="' + GRAXUrl + BaseRoute + '/$metadata">' +
        '<workspace>' +
